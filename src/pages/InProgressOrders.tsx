...
import { Search, PackagePlus, MapPin, Grid3X3, List, MoreVertical, Truck, Bike, Play } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={`Orders currently being delivered (${inProgressOrders.length} orders)`}
        action={
          <button
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        {viewMode === 'grid' ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {filteredOrders.map((order) => (
              <div
                key={order.id}
                className="border border-blue-200 rounded-lg p-4 hover:shadow-md transition-shadow bg-blue-50/30"
              >
        ...
        {filteredOrders.length === 0 && (
          <div className="text-center py-12">
            <Play size={48} className="mx-auto text-blue-300 mb-4" />
